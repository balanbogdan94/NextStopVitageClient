...
const Home = () => {
    ...
    useEffect( () => {
     ...
     const getAllPics = () => {
        let images = listOfImages.map(
            (image, index) => <img className="no-background" key={index} src={image.default} alt="info"/>
            )
        return images
     }
    ...
    return (
        <div className="home-container">
            ...
            <div className="image-container">
                <img
                    alt="sale"
                    src="images/Home/home-sale.webp" />
            </div>
            <div className="brand-container">
                <img  className="background-image" alt="background effect" src={background}/>
